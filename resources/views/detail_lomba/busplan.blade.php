...
<body class="bg-blue-200">
    <nav id="navbar" class="fixed top-0 z-50 w-full border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-between p-4 ">
        ...
        <div class="hidden md:flex md:flex-grow md:justify-center" id="navbar-sticky">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="/" class="block py-2 px-3 text-gray-900 bg-blue-700 rounded md:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                </li>
                <li>
    ...
    {{-- <div class="awan">
        ...
        <img src="{{ asset('images/Awan.png') }}" alt="" class="-z-20 fixed mt-[100px] scale-50 ml-[2000px] md:transform-none" id="awan-2">
    </div> --}}
    <div class="container  mx-auto mt-16 flex justify-center">
        <div class="container-main bg-slate-50 w-2/3 relative justify-center mb-10 rounded-md my-20">
            <div class="content-atas mb-6 text-center mt-10">
                ...
                <p class="text-lg mb-4 font-medium">ICT BUSINESS PLAN</p>
...
pada IT Convert 2025 yang berfokus pada perencanaan model bisnis dengan produk
...
di bidang TIK.</p>
            <div class="flex justify-center gap-4">
                ...
                <a href="{{ route('proposal', ['filename' => 'BMC - BUSINESS PLAN ITC 2024.docx']) }}" class="text-white rounded-md bg-[#61C6ED] hover:bg-[#2BBCEE] px-6 py-2">BMC</a>
                    ...
                    <div>
                        <ol class="relative border-s p-3 border-gray-200 dark:border-gray-700">
                            <li class="mb-10 ms-6">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">June 27th, 2025 - July 27th, 2025</time>
                                <br>
                            ...
                            <li class="mb-10 ms-6">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">July 28th, 2025 - August 2nd, 2025</time>
                            </li>
                            <li class="mb-10 ms-6">
                                <div class="">
                                    <span class="absolute flex items-center justify-center w-10 h-10 -ml-2 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">August 10th, 2025</time>
                            </li>
                            <li class="mb-10 ms-6">
                                <div class="">
                                    <span class="absolute flex items-center justify-center w-10 h-10 -ml-2 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">August 10th, 2025 - August 26th, 2025</time>
                            ...
                            <li class="mb-10 ms-6">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"> August 27th, 2025 - August 29th, 2025</time>
                            </li>
                            <li class="mb-10 ms-6">
                                <div class="">
                                    <span class="absolute flex items-center justify-center w-10 h-10 -ml-2 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 6th, 2025</time>
                            </li>
                            <li class="mb-10 ms-6">
                                <div class="">
                                    <span class="absolute flex items-center justify-center w-10 h-10 -ml-2 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 6th, 2025 - September 19th, 2025</time>
                            </li>
                            <li class="mb-10 ms-6">
                                <div class="">
                                    <span class="absolute flex items-center justify-center w-10 h-10 -ml-2 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                ...
                                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 20th, 2025</time>
                            </li>
                        </ol>
                    </div>
